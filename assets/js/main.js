...
(function() {
  ...
  const menuItems = [
    ...
    { name: "Chicken Ala King W/ Rice", category: "Brunch", price: 150 },
    { name: "Apple Shake", category: "Non-Coffee Drinks", price: 120 },
    { name: "Avocado", category: "Non-Coffee Drinks", price: 115 },
    { name: "Avocado Frappe", category: "Non-Coffee Drinks", price: 105 },
    { name: "Beef Tapa W/ Rice & Egg", category: "Brunch", price: 150 },
    { name: "Beefy Nacho Fries", category: "Starter", price: 195 },
    { name: "Blue Lemonade", category: "Non-Coffee Drinks", price: 70 },
    { name: "Brewed Coffee Plain Black", category: "Espresso", price: 55 },
    { name: "Brewed Coffee With Milk", category: "Espresso", price: 65 },
    { name: "Caesar Salad", category: "Salads", price: 210 },
    { name: "Caffe Mocha Latte", category: "Espresso", price: 130 },
    { name: "Caramel Macchiato", category: "Espresso", price: 130 },
    ...
    { name: "Cheesy Egg Sandwich", category: "Sandwiches", price: 90 },
    { name: "Cheesy Meaty Fries", category: "Starter", price: 110 },
    { name: "Creamy Chicken Pesto W/Rice", category: "Brunch", price: 150 },
    { name: "Chicken Fillet W/Rice", category: "Brunch", price: 150 },
    { name: "Chicken Salad", category: "Salads", price: 220 },
    { name: "Chicken Sandwich", category: "Sandwiches", price: 105 },
    { name: "Chicken Strips", category: "Starter", price: 150 },
    ...
    { name: "Chocolate Waffle", category: "Starter", price: 120 },
    ...
    { name: "Coke In Can", category: "Non-Coffee Drinks", price: 60 },
    { name: "Cookies And Cream Frappe", category: "Non-Coffee Drinks", price: 130 },
    { name: "Corn Shake", category: "Shakes", price: 110 },
    { name: "Cornsilog", category: "Brunch", price: 100 },
    ...
    { name: "Dragon Fruit", category: "Non-Coffee Drinks", price: 120 },
    { name: "Fish Fillet", category: "Brunch", price: 150 },
    { name: "French Toast", category: "Sandwiches", price: 100 },
    { name: "Fresh Buko", category: "Non-Coffee Drinks", price: 80 },
    ...
    { name: "Frozen Iced Tea", category: "Non-Coffee Drinks", price: 90 },
    { name: "Garlic Rice", category: "Brunch", price: 25 },
    { name: "Grape Slush", category: "Non-Coffee Drinks", price: 130 },
    { name: "Ham & Egg Sandwich", category: "Sandwiches", price: 115 },
    { name: "Ham & Egg With Rice", category: "Brunch", price: 115 },
    { name: "Hazelnut Latte", category: "Espresso", price: 110 },
    { name: "Americano", category: "Espresso", price: 75 },
    { name: "Hot Caramel Latte", category: "Espresso", price: 85 },
    { name: "Hot Chocolate", category: "Non-Coffee Drinks", price: 100 },
    ...
    { name: "Iced Matcha Latte", category: "Non-Coffee Drinks", price: 130 },
    ...
    { name: "Shrimp Pesto  Pasta", category: "Pastas", price: 180 },
    { name: "Pitcher", category: "Non-Coffee Drinks", price: 200 },
    { name: "3 Cheese Pizza", category: "Pizza", price: 210 },
    { name: "Hawaiian Pizza", category: "Pizza", price: 210 },
    { name: "Italian Pizza", category: "Pizza", price: 210 },
    { name: "Pepperoni Pizza", category: "Pizza", price: 210 },
    { name: "Garlic Truffle Pizza", category: "Pizza", price: 210 },
    { name: "Pup Cup", category: "Dog Menu", price: 35 },
    { name: "Pupsicle", category: "Dog Menu", price: 70 },
    { name: "Royal In Can", category: "Non-Coffee Drinks", price: 60 },
    { name: "Salted Caramel Latte", category: "Espresso", price: 115 },
    ...
    { name: "Spam & Egg W/ Rice", category: "Brunch", price: 130 },
    { name: "Spam Sandwich", category: "Sandwiches", price: 120 },
    { name: "Spanish Latte", category: "Espresso", price: 115 },
    { name: "Strawberry Frappe", category: "Non-Coffee Drinks", price: 115 },
    { name: "Strawberry Latte", category: "Non-Coffee Drinks", price: 130 },
    { name: "Strawberry Red Tea", category: "Non-Coffee Drinks", price: 70 },
    { name: "Strawberry Smoothie", category: "Non-Coffee Drinks", price: 125 },
    { name: "Strawberry Waffle", category: "Starter", price: 140 },
    { name: "Tocino W/Rice", category: "Brunch", price: 100 },
    { name: "Tuna Salad", category: "Salads", price: 220 },
    { name: "Vanilla Caramel Frappe", category: "Non-Coffee Drinks", price: 120 },
    { name: "Vanilla Waffle", category: "Starter", price: 120 },
    { name: "Watermelon Shake", category: "Shakes", price: 110 }
  ];
